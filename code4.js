...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17375692);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17380812);
}
}
if (isConditionTrue_0) {
...
};gdjs.IntroCode.asyncCallback17387348 = function (runtimeScene, asyncObjectsList) {
...
gdjs.IntroCode.idToCallbackMap.set(17387348, gdjs.IntroCode.asyncCallback17387348);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(4), (runtimeScene) => (gdjs.IntroCode.asyncCallback17387348(runtimeScene, asyncObjectsList)), 17387348, asyncObjectsList);
}
}
...
};gdjs.IntroCode.asyncCallback17386972 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.IntroCode.localVariables);
...
gdjs.IntroCode.idToCallbackMap.set(17386972, gdjs.IntroCode.asyncCallback17386972);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.IntroCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.IntroCode.asyncCallback17386972(runtimeScene, asyncObjectsList)), 17386972, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17382812);
}
}
if (isConditionTrue_0) {
...
};gdjs.IntroCode.asyncCallback17389684 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.IntroCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Office", false);
}
gdjs.IntroCode.localVariables.length = 0;
}
gdjs.IntroCode.idToCallbackMap.set(17389684, gdjs.IntroCode.asyncCallback17389684);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.IntroCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(8), (runtimeScene) => (gdjs.IntroCode.asyncCallback17389684(runtimeScene, asyncObjectsList)), 17389684, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17390700);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getGame().getVariables().getFromIndex(7).getAsNumber() == 6);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17391804);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
