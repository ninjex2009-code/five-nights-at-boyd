...
gdjs.Game_32Over_32ScreenCode.asyncCallback18422724 = function (runtimeScene, asyncObjectsList) {
...
gdjs.Game_32Over_32ScreenCode.idToCallbackMap.set(18422724, gdjs.Game_32Over_32ScreenCode.asyncCallback18422724);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Game_32Over_32ScreenCode.asyncCallback18422724(runtimeScene, asyncObjectsList)), 18422724, asyncObjectsList);
}
}
...
};gdjs.Game_32Over_32ScreenCode.asyncCallback18423980 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Game_32Over_32ScreenCode.localVariables);
...
gdjs.Game_32Over_32ScreenCode.idToCallbackMap.set(18423980, gdjs.Game_32Over_32ScreenCode.asyncCallback18423980);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Game_32Over_32ScreenCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Game_32Over_32ScreenCode.asyncCallback18423980(runtimeScene, asyncObjectsList)), 18423980, asyncObjectsList);
}
}
...
};gdjs.Game_32Over_32ScreenCode.asyncCallback18428276 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Game_32Over_32ScreenCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Main Menu", false);
}
gdjs.Game_32Over_32ScreenCode.localVariables.length = 0;
}
gdjs.Game_32Over_32ScreenCode.idToCallbackMap.set(18428276, gdjs.Game_32Over_32ScreenCode.asyncCallback18428276);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Game_32Over_32ScreenCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.Game_32Over_32ScreenCode.asyncCallback18428276(runtimeScene, asyncObjectsList)), 18428276, asyncObjectsList);
}
}
...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18428116);
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18422580);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18425404);
}
}
}
if (isConditionTrue_0) {
